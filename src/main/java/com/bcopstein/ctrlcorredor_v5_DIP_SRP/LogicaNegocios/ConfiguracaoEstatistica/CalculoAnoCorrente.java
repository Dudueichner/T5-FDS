...
public class CalculoAnoCorrente implements CalculoEstatistica{

    IEventoRepository eventoRep;

    CalculoAnoCorrente(IEventoRepository eventoRep){
    ...
    public EstatisticasDTO calculaEstatisticas(int distancia) {
        ...
        List<Evento> eventos = 
            eventoRep.todos()
                .stream()
                .filter(e->e.getDistancia() == distancia && e.getAno() == 2022)
